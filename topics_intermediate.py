# topics_intermediate.py
"""
Intermediate Python topics (7-13) for Pytalon.
...
def teach_input_function():
    """Topic 8: Input Function in Python."""
    print_global_separator()
...
# ---- Sub-topic 1: String Basics ----
def _teach_string_basics():
    """Sub-topic: String basics and creation."""
    print_global_separator()
...
def _teach_string_indexing():
    """Sub-topic: String indexing and slicing."""
    print_global_separator()
...
def _teach_string_operations():
    """Sub-topic: String operations."""
    print_global_separator()
...
def _teach_string_methods():
    """Sub-topic: Common string methods."""
    print_global_separator()
...
def _teach_string_formatting():
    """Sub-topic: String formatting."""
    print_global_separator()
...
# ---- Sub-topic 6: Common Errors ----
def _teach_string_errors():
    """Sub-topic: Common string errors and best practices."""
    print_global_separator()
...
# ---- Complete Strings Guide ----
def _teach_all_string_topics():
    """Teach all string topics in sequence."""
    _teach_string_basics()
    _teach_string_indexing()
    _teach_string_operations()
    _teach_string_methods()
    _teach_string_formatting()
    _teach_string_errors()

# ---- Main Strings Entry Point ----
def teach_strings():
    """Topic 10: Comprehensive guide to Python strings."""
    print("\n   💬 What are strings?")
...
# ---- Sub-topic 1: IF Statements ----
def _teach_conditionals_basics():
    """Sub-topic: IF statements basics."""
    print_global_separator()
...
# ---- Sub-topic 3: Elif Statements ----
def _teach_elif():
    """Sub-topic: Elif statements."""
    print_global_separator()
...
def _teach_nested_conditionals():
    """Sub-topic: Nested conditionals."""
    print_global_separator()
...
# ---- Sub-topic 5: Combining Conditions ----
def _teach_conditional_operators():
    """Sub-topic: Combining conditions with AND, OR, NOT."""
    print_global_separator()
...
# ---- Sub-topic 6: Common Mistakes ----
def _teach_common_mistakes():
    """Sub-topic: Common mistakes with conditional statements."""
    print_global_separator()
...
# ---- Complete Conditionals Guide ----
def _teach_all_conditional_topics():
    """Teach all conditional topics in sequence."""
    _teach_conditionals_basics()
    _teach_if_else()
    _teach_elif()
    _teach_nested_conditionals()
    _teach_conditional_operators()
    _teach_common_mistakes()

# ---- Main Conditionals Entry Point ----
def teach_conditionals():
    """Topic 12: Comprehensive guide to conditional statements."""
    print("\n   🤔 What are conditional statements?")
...
# ---- Sub-topic 1: List Basics ----
def _teach_list_basics():
    """Sub-topic: List basics and creation."""
    print_global_separator()
...
# ---- Sub-topic 2: Indexing ----
def _teach_list_indexing():
    """Sub-topic: Accessing list elements using indices."""
    print_global_separator()
...
# ---- Sub-topic 3: Slicing ----
def _teach_list_slicing():
    """Sub-topic: Extracting sublists using slicing."""
    print_global_separator()
...
# ---- Sub-topic 4: List Methods ----
def _teach_list_methods():
    """Sub-topic: Common list methods."""
    print_global_separator()
...
# ---- Sub-topic 5: List Operations ----
def _teach_list_operations():
    """Sub-topic: List operations (concatenation, repetition, membership)."""
    print_global_separator()
...
# ---- Sub-topic 6: Looping ----
def _teach_list_looping():
    """Sub-topic: Looping through lists."""
    print_global_separator()
...
# ---- Sub-topic 7: List Comprehension ----
def _teach_list_comprehension():
...
# ---- Sub-topic 8: Common Errors ----
def _teach_list_errors():
    """Sub-topic: Common errors when working with lists."""
    print_global_separator()
...
# ---- Complete Lists Guide ----
def _teach_all_list_topics():
    """Teach all list topics in sequence."""
    _teach_list_basics()
    _teach_list_indexing()
    _teach_list_slicing()
    _teach_list_methods()
    _teach_list_operations()
    _teach_list_looping()
    _teach_list_comprehension()
    _teach_list_errors()

# ---- Main Lists Entry Point ----
def teach_lists():
    """Topic 13: Comprehensive guide to Python lists."""
    print("\n   📋 What are lists?")
...
INTERMEDIATE_TOPICS = {
    'Type conversion': teach_type_conversion,
    'Input function': teach_input_function,
    'Comments in Python': teach_comments,
    'Strings in Python': teach_strings,
    'Data types in Python': teach_data_types,
    'Conditional statements': teach_conditionals,
    'Lists in Python': teach_lists,
}
