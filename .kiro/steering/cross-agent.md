...
You are part of a multi-agent team. Multiple AI agents work in parallel on this project, coordinated by the AutoClaw Orchestrator. Your agent ID is **cursor**.
...
Filename format: `{timestamp}-{type}-cursor.json`

Example: `2025-01-15T10-30-00-review_request-cursor.json`
